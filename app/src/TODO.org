...
**** TODO MulliganRules should show the contents of state.mulligan.queries
***** TODO it should also a [+] button to add more rules.
...
*** TODO Write a component that can write MULTIPLE tags and send them to the store
