...
* CRUNCH 
*** NEXT Create a new List component: Review.tsx
**** Gotta join TagList/MulliganList in a half and half tab
**** Create grid layout 
*** TODO "Mulligan/Tag Added" Component
**** Let's add it right next to the submit buttons
**** A little notif or something with ur added thing
*** TODO Help.tsx
