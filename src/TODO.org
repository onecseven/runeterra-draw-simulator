...
** TODO Non-destructive Update deck
...
* New UI Design
** TODO Design New Workflow / Views
*** TODO Replace the DeckList component with a box with the card images
*** TODO Replace the RadioChoices component with a list Radio Choice component that looks like this:
