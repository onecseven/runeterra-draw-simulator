...
*** TODO Redo the Simulation Component
**** TODO Add a NumberSimInput component to figure out how many hands to calculate
**** TODO Once we have calculated, then render features/rules/tags/tag displays/CounterList beneath it
